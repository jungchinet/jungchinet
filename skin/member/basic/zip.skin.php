...
<tr> 
    ...
    <td><input type=text name=addr1 value='<?=$addr1?>' required minlength=2 itemname='동(읍/면/리)' size=35> <input type=image src='<?=$g4[bbs_img_path]?>/btn_post_search.gif' border=0 align=absmiddle style="ime-mode:active;" ></td>
</tr>
<tr> 
    <td height="20" colspan="2"></td>
</tr>
