...
<tr height="25">
  ...
  <table width="101%" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
  ...
  <?echo $bb_s;?><a href='./board.php?bo_table=<?=$bo_table?>&page=<?=$page?>'><span class=L_Tcategory><b>전체</b></span></a><?=$bb_e?> 
  </td>
