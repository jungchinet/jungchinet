...
// 처음 쓰기의 경우 초기화
if ($w == "") {
    $write[wr_1] = $g4['time_ymdhis'];
    $write[wr_2] = date("Y-m-d", $g4['server_time'] + 7*86400) . " 24:00:00"; // 오늘부터 7일후 밤 24시로 기본설정
    $write[wr_3] = "200";          // 팝업위치 - 왼쪽
    $write[wr_4] = "200";          // 팝업위치 - 상단
    $write[wr_5] = "400";          // 팝업크기 - 가로
    $write[wr_6] = "300";          // 팝업크기 - 세로
    $write[wr_7] = "1";            // 쿠키일수
    $write[wr_8] = "하루동안 창을 열지 않습니다";
    $write[wr_10] = "checked";     // 배경이미지 반복
}
?>
<tr>
    <td style='padding-left:20px; height:30px;'>· 팝업일시</td>
    <td>시작 <input class='field_pub_01' size=20 name=wr_1 itemname="팝업시작" value="<?=$write[wr_1]?>"> - 종료 <input class='field_pub_01' size=20 name=wr_2 itemname="팝업종료" value="<?=$write[wr_2]?>">
    </td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td style='padding-left:20px; height:30px;'>· 팝업위치(px)</td>
    <td>왼쪽 <input class='field_pub_01' size=20 name=wr_3 itemname="팝업위치-왼쪽" value="<?=$write[wr_3]?>"> - 상단 <input class='field_pub_01' size=20 name=wr_4 itemname="팝업위치-상단" value="<?=$write[wr_4]?>">
    </td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td style='padding-left:20px; height:30px;'>· 팝업크기(px)</td>
    <td>가로 <input class='field_pub_01' size=20 name=wr_5 itemname="팝업크기-가로" value="<?=$write[wr_5]?>"> - 세로 <input class='field_pub_01' size=20 name=wr_6 itemname="팝업크기-세로" value="<?=$write[wr_6]?>">
    </td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td style='padding-left:20px; height:30px;'>· 팝업쿠키</td>
    <td>일수 <input class='field_pub_01' size=20 name=wr_7 itemname="팝업쿠키-일수" value="<?=$write[wr_7]?>"> - 출력 <input class='field_pub_01' size=40 name=wr_8 itemname="팝업쿠키-출력" value="<?=$write[wr_8]?>">
    </td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td style='padding-left:20px; height:30px;'>· 팝업옵션</td>
    <td>맵 # <input class='field_pub_01' size=20 name=wr_9 itemname="글자패딩" value="<?=$write[wr_9]?>"> - 배경이미지반복 <input type=checkbox value="wr_10" name="wr_10" <?=$write[wr_10]?>>
    </td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<!-- 팝업영역 -->
...
<? if ($is_file) { ?>
<tr>
    <td style='padding-left:20px; height:30px;' valign=top><table cellpadding=0 cellspacing=0><tr><td style=" padding-top: 10px;">· 배경 <span onclick="add_file();" style='cursor:pointer; font-family:tahoma; font-size:12pt;'>+</span> <span onclick="del_file();" style='cursor:pointer; font-family:tahoma; font-size:12pt;'>-</span></td></tr></table></td>
