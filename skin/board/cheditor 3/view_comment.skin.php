    ...
    <td width='100%'>
        ...
        <tr>
            <td valign=top>
                ...
                <? if ($list[$i]['mb_id'] != 'jungchinet' && $is_ip_view) { echo "&nbsp;<span style=\"color:#B2B2B2; font-size:11px;\">{$list[$i][ip]}</span>"; } ?>
                ...
                <? if ($list[$i][singo_href]) { ?>&nbsp;<a href="<?=$g4[path]?>/bbs/singo_popin_update.php?bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id]?>&wr_parent=<?=$wr_id?>"><img src='<?=$board_skin_path?>/img/icon_singo.gif' alt='singo'></a><?}?>
