...
// cdn에 이미지를 올렸을 경우에는 $board_skin_path를 변경해 줍니다.
...
// 유니크로
if ($write_href) {
    // 유니크로 쓰기만을 허용할 게시판을 지정 합니다.
    $only_unicro_board = array("unicro_09_assign","unicro_sell_assign");

    if (in_array($bo_table, $only_unicro_board) && !$is_admin) {
       $write_href = "http://$g4[unicro_url]/item/itemInput.jsp?bo_table=$bo_table";
...
<tr height="25">
    ...
    <? } ?>
    <td align="right" style="font:normal 11px tahoma; color:#BABABA;" width="120">
...
<tr height=28 align=center>
    ...
    <td align=left style='word-break:break-all;'>
        ...
        */
        ...
        echo "$subject_img<a href='{$list[$i][href]}' $style>";
        echo $list[$i][subject];
        echo "</a>";
...
<tr>
    <td width="50%" height="40">
        ...
        <? if ($write_href) { ?><a href="<?=$write_href?>" <?=$target_href?>><img src="<?=$board_skin_path?>/img/btn_write.gif" border="0"></a><? } ?>
        <? if ($is_checkbox) { ?>
...
<tr>
    <td width="50%" height="20">
        <a href="http://www.unicro.co.kr/" target=new>유니크로</a>
        <a href="http://unicro.diorcafe.co.kr/bbs/bbsList.jsp" target=_top>고객센터</a>
        <a href="http://unicro.diorcafe.co.kr/my/saleList.jsp" target=_top>판매관리</a>
        <a href="http://unicro.diorcafe.co.kr/my/my.jsp" target=_top>구매관리</a>
        <a href="<?=$_SERVER[PHP_SELF]?>?bo_table=unicro_qna">묻고답하기</a>
    </td>
    <td width="50%" height="20" align=right>
        <a href="<?=$_SERVER[PHP_SELF]?>?bo_table=<?=$bo_table?>&sfl=wr_3&stx=판매"><img src="<?=$board_skin_path?>/img/safe_ico.gif" border="0" title="유니크로" align=absmiddle></a>
        <a href="<?=$_SERVER[PHP_SELF]?>?bo_table=<?=$bo_table?>&sfl=wr_5&stx=진행중"><img src="<?=$board_skin_path?>/img/unicro_ico_deal_ok.gif" border="0" title="거래가능" align=absmiddle></a>
        <a href="<?=$_SERVER[PHP_SELF]?>?bo_table=<?=$bo_table?>&sfl=wr_8&stx=1"><img src="<?=$board_skin_path?>/img/secret_ico.gif" border="0" title="구매자지정" align=absmiddle></a>
    </td>
</tr>
</table>
</form>
