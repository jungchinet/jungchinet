...
if ($is_notice || $is_html || $is_secret || $is_mail) { 
    ...
    if ($is_secret && $member['mb_id']) {
        $option .= "<a href=javascript:popup_id('fwrite','$ss_id',200,500);>";
        $option .= "<span class=w_title>아이디지정</span></a>";
        $option .= "<INPUT type=text maxLength=50 size=10 value='$write[$ss_id]' name='$ss_id'>&nbsp;";
    }
