...
<tr bgcolor=#E3DCD2 height=70>
    <td colspan=2 onmouseover="layer_view('','','','','')"><a href='<?=$g4['admin_path']?>/'><img src='./img/logo.gif' border=0></a></td>
    <td>
        <?
        foreach($amenu as $key=>$value)
        {
            ...
            echo "{$href1}<img src='$g4[manual_path]/img/menu{$key}.gif' border=0 id='id_menu{$key}' onmouseover=\"layer_view('id_menu{$key}', 'menu_menu{$key}', 'view', -2, 5);\">{$href2}&nbsp; ";
...
<tr onmouseover="layer_view('','','','','')">
    <td valign=top>
        ...
        <?
        echo "<tr><td><img src='$g4[manual_path]/img/title_menu{$tmp_menu}.gif'></td></tr>";
