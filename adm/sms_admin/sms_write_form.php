...
$paging = get_paging(10, $page, $total_page, "sms_write_form.php?fg_no=$fg_no&st=$st&sv=$sv&page="); 
...
function go(fo_no)
{
    var wr_message = parent.document.getElementById('wr_message');

    //wr_message.focus();
    wr_message.value = document.getElementById('fo_contents_' + fo_no).value;

    parent.byte_check('wr_message', 'sms_bytes');
}
</script>
