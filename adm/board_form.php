...
<tr class='ht'>
    ...
    <td>상단우측 링크</td>
    <td>
        <input type=text class=ed name=bo_rtlink size=300 itemname='상단우측 링크' value='<?=get_text($board[bo_rtlink])?>' style='width:80%;'>
    </td>
</tr>
<tr class='ht'>
    <td></td>
...
<tr class='ht'>
    ...
    <td colspan='2'>
        <table id='hiddenrssTable' style='display:none;'>
            <tr class='ht'>
                <td style='width:50px;'>RSS 주소</td>
                <td>
                    <input type='text' class='ed' name='rss_addr[]' value='' style='width:60px;' />
                        &nbsp;&nbsp;· 구분 <select name='rss_opt1[]'><?=$rssOpt1?></select>
                        &nbsp;&nbsp;· 관심단어 <input type=text class=ed style='width:80px;' name=rss_opt3[] itemname='관심단어' value='<?=$r['rss_opt3']?>'>
                        &nbsp;&nbsp;· 비고 <input type=text class=ed style='width:90px;' name=rss_opt4[] itemname='비고' value='<?=$r['rss_opt4']?>'>
                        &nbsp;&nbsp;· 읽을갯수 <input type=text class=ed style='width:20px;' name=rss_num[] itemname='갯수' value='<?=$r['rss_num']?>'>
                        &nbsp;&nbsp;· A <input type=radio name=rss_ao[] itemname='AND_OR' value='1' <? ($r['rss_ao']=='1')?checked:''; ?>> O <input type=radio name=rss_ao[] itemname='AND_OR' value='2' <? ($r['rss_ao']=='2')?checked:''; ?>>
                </td>
            </tr>
        </table>
        <table id='rssTable'>
        <? if($rssNum==0){ ?>
            <tr class='ht'>
                <td style='width:50px;'>RSS 주소 <span id='addBtn' style='cursor:pointer;'>+</span> <span id='delBtn' style='cursor:pointer;'>-</span></td>
                <td>
                    <input type='text' class='ed' name='rss_addr[]' value='' style='width:60px;' />
                        &nbsp;&nbsp;· 구분 <select name='rss_opt1[]'><?=$rssOpt1?></select>
                        &nbsp;&nbsp;· 관심단어 <input type=text class=ed style='width:80px;' name=rss_opt3[] itemname='관심단어' value='<?=$r['rss_opt3']?>'>
                        &nbsp;&nbsp;· 비고 <input type=text class=ed style='width:90px;' name=rss_opt4[] itemname='비고' value='<?=$r['rss_opt4']?>'>
                        &nbsp;&nbsp;· 읽을갯수 <input type=text class=ed style='width:20px;' name=rss_num[] itemname='갯수' value='<?=$r['rss_num']?>'>
                        &nbsp;&nbsp;· A <input type=radio name=rss_ao[0] itemname='AND_OR' value='1' <? ($r['rss_ao']=='1')?checked:''; ?>> O <input type=radio name=rss_ao[0] itemname='AND_OR' value='2' <? ($r['rss_ao']=='2')?checked:''; ?>>
                </td>
            </tr>
        <? }else{
        ...
        ?>
            <tr class='ht'>
                <td style='width:50px;'>RSS 주소 <span id='addBtn' style='cursor:pointer;'>+</span> <span id='delBtn' style='cursor:pointer;'>-</span></td>
                <td>
                    <input type='text' class='ed' name='rss_addr[]' value='<?=$r['rss_addr']?>' style='width:60px;' />
                        &nbsp;&nbsp;· 구분 <select name='rss_opt1[]'><?=$rssOptRead1?></select>
                        &nbsp;&nbsp;· 관심단어 <input type=text class=ed style='width:80px;' name=rss_opt3[] itemname='관심단어' value='<?=$r['rss_opt3']?>'>
                        &nbsp;&nbsp;· 비고 <input type=text class=ed style='width:90px;' name=rss_opt4[] itemname='비고' value='<?=$r['rss_opt4']?>'>
                        &nbsp;&nbsp;· 읽을갯수 <input type=text class=ed style='width:20px;' name=rss_num[] itemname='갯수' value='<?=$r['rss_num']?>'>
                        &nbsp;&nbsp;· A <input type=radio name=rss_ao[1] itemname='AND_OR' value='1' <? if($r['rss_ao']=='1'){ echo 'checked'; } ?>> O <input type=radio name=rss_ao[1] itemname='AND_OR' value='2' <? if($r['rss_ao']=='2'){ echo 'checked'; } ?>>
                </td>
            </tr>
                ...
                <tr class='ht'>
                    ...
                    <td>
                        <input type='text' class='ed' name='rss_addr[]' value='<?=$r['rss_addr']?>' style='width:60px;' />
                            ...
                            &nbsp;&nbsp;· 비고 <input type=text class=ed style='width:90px;' name=rss_opt4[] itemname='비고' value='<?=$r['rss_opt4']?>'>
                            &nbsp;&nbsp;· 읽을갯수 <input type=text class=ed style='width:20px;' name=rss_num[] itemname='갯수' value='<?=$r['rss_num']?>'>
                            &nbsp;&nbsp;· A <input type=radio name=rss_ao[<?=$aon?>] itemname='AND_OR' value='1' <? if($r['rss_ao']=='1'){ echo 'checked'; } ?>> O <input type=radio name=rss_ao[<?=$aon?>] itemname='AND_OR' value='2' <? if($r['rss_ao']=='2'){ echo 'checked'; } ?>>
                    </td>
                </tr>
            <? $aon++; } ?>
        <? } ?>
