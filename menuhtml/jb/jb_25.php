...
//서울신문
$url="https://news.google.co.kr/news?hl=ko&ned=kr&ie=UTF-8&q=%EA%B3%A0%EC%9A%A9%EB%85%B8%EB%8F%99%EB%B6%80&output=rss";
...
<div id="wrap">
 ...
 <p><a href="http://www.moel.go.kr/"><img src="/menuhtml/jb/employment.gif" width="400" height="107" align=absmiddle /></a></p></td></table>
 ...
 <div class="body3">
  ...
  <div class="assem1_profile"></div>
                        <a class="twitter-timeline"  href="https://twitter.com/search?q=%EA%B3%A0%EC%9A%A9%EB%85%B8%EB%8F%99%EB%B6%80%20OR%20%EB%85%B8%EB%8F%99%EB%B6%80" data-widget-id="644927696946925568" width="320" height="380" data-chrome="noheader nofooter noscrollbar ">고용노동부 OR 노동부에 대한 트윗</a>
 ...
 <div class="body2">
  ...
  <div class="company_sub">고용노동부 산하 공기업 및 공공기관</div>
  <div class="company1_picture"><a href="http://www.kcomwel.or.kr">근로복지공단</a></div>
  <div class="company1_profile">
    <ul>
      <li>준정부기관(기금관리형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.cwma.or.kr">건설근로자공제회</a></div>
  <div class="company2_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.nosa.or.kr">노사발전재단</a></div>
  <div class="company3_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.kopo.ac.kr">학교법인한국폴리텍</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.koreatech.ac.kr">한국기술교육대학교</a></div>
  <div class="company5_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company6_picture"><a href="http://www.kosha.or.kr/">한국산업안전보건공단</a></div>
  <div class="company6_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.hrdkorea.or.kr">한국산업인력공단</a></div>
  <div class="company1_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.kead.or.kr">한국장애인고용공단</a></div>
  <div class="company2_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.keis.or.kr">한국고용정보원</a></div>
  <div class="company3_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.kest.or.kr">한국승강기안전기술원</a></div>
  <div class="company4_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.socialenterprise.or.kr">한국사회적기업진흥원</a></div>
  <div class="company5_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company6_picture"><a href="http://koreajobworld.or.kr">한국잡월드</a></div>
  <div class="company6_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
