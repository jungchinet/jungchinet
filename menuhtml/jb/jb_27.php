...
//서울신문
$url="https://news.google.co.kr/news?hl=ko&ned=kr&ie=UTF-8&q=%EA%B5%AD%ED%86%A0%EA%B5%90%ED%86%B5%EB%B6%80&output=rss";
...
<div id="wrap">
 ...
 <p><a href="http://www.molit.go.kr/"><img src="/menuhtml/jb/landtrans.gif" width="300" height="163" align=absmiddle /></a></p></td></table>
 ...
 <div class="body3">
  ...
  <div class="assem1_profile"></div>
                         <a class="twitter-timeline"  href="https://twitter.com/search?q=%EA%B5%AD%ED%86%A0%EA%B5%90%ED%86%B5%EB%B6%80%20OR%20%EA%B5%AD%ED%86%A0%EB%B6%80" data-widget-id="644928511933681664" width="320" height="380" data-chrome="noheader nofooter noscrollbar ">국토교통부 OR 국토부에 대한 트윗</a>
 ...
 <div class="body2">
  ...
  <div class="company_sub">국토교통부 산하 공기업 및 공공기관</div>
  <div class="company4_picture"><a href="http://www.ts2020.kr">교통안전공단</a></div>
  <div class="company4_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.kaia.re.kr">국토교통과학기술진흥원</a></div>
  <div class="company5_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.khgc.co.kr">대한주택보증주식회사</a></div>
  <div class="company1_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.lx.or.kr">대한지적공사</a></div>
  <div class="company2_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.airport.kr">인천국제공항공사</a></div>
  <div class="company3_profile">
    <ul>
      <li>공기업(시장형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://waterway.or.kr">(주)워터웨이플러스</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.jdcenter.com">제주국제자유도시개발센터</a></div>
  <div class="company5_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.kohom.co.kr">주택관리공단(주)</a></div>
  <div class="company1_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://koraillogis.com">코레일로지스(주)</a></div>
  <div class="company2_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.korailretail.com">코레일유통(주)</a></div>
  <div class="company3_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.korailtravel.com">코레일관광개발(주)</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
 <div class="company1_picture"><a href="http://www.korailnetworks.com">코레일네트웍스(주)</a></div>
  <div class="company1_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.korailtech.kr">코레일테크(주)</a></div>
  <div class="company2_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.kab.co.kr">한국감정원</a></div>
  <div class="company3_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.korcm.co.kr">(주)한국건설관리공사</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.airport.co.kr">한국공항공사</a></div>
  <div class="company5_profile">
    <ul>
      <li>공기업(시장형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.ex.co.kr">한국도로공사</a></div>
  <div class="company1_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.kwater.or.kr">한국수자원공사</a></div>
  <div class="company2_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.kistec.or.kr">한국시설안전공단</a></div>
  <div class="company3_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.korail.com">한국철도공사</a></div>
  <div class="company4_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.kr.or.kr">한국철도시설공단</a></div>
  <div class="company5_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.lh.or.kr">한국토지주택공사</a></div>
  <div class="company1_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.haewul.com">(주)해울</a></div>
  <div class="company2_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.kiast.or.kr">항공안전기술원</a></div>
  <div class="company3_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
