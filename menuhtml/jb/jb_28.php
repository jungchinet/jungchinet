...
//서울신문
$url="https://news.google.co.kr/news?hl=ko&ned=kr&ie=UTF-8&q=%ED%95%B4%EC%96%91%EC%88%98%EC%82%B0%EB%B6%80OR%ED%95%B4%EC%88%98%EB%B6%80&output=rss";
...
<div id="wrap">
 ...
 <p><a href="http://www.mof.go.kr/"><img src="/menuhtml/jb/oceanfish.gif" width="350" height="153" align=absmiddle /></a></p></td></table>
 ...
 <div class="body3">
  ...
  <div class="assem1_profile"></div>
                         <a class="twitter-timeline"  href="https://twitter.com/search?q=%ED%95%B4%EC%96%91%EC%88%98%EC%82%B0%EB%B6%80%20OR%20%ED%95%B4%EC%88%98%EB%B6%80" data-widget-id="644929112713203712" width="320" height="380" data-chrome="noheader nofooter noscrollbar ">해양수산부 OR 해수부에 대한 트윗</a>
 ...
 <div class="body2">
  ...
  <div class="company_sub">해양수산부 산하 공기업 및 공공기관</div>
  <div class="company4_picture"><a href="http://www.busanpa.com">부산항만공사</a></div>
  <div class="company4_profile">
    <ul>
      <li>공기업(시장형)</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.kst.or.kr/">선박안전기술공단</a></div>
  <div class="company5_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="www.icpa.or.kr">인천항만공사</a></div>
  <div class="company1_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.ygpa.or.kr">여수광양항만공사</a></div>
  <div class="company2_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.upa.or.kr">울산항만공사</a></div>
  <div class="company3_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.bpsc.co.kr">주식회사 부산항보안공사</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://www.port.co.kr">주식회사 인천항보안공사</a></div>
  <div class="company5_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company1_picture"><a href="http://www.seaman.or.kr">한국해양수산연수원</a></div>
  <div class="company1_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.kiost.ac">한국해양과학기술원</a></div>
  <div class="company2_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.kriso.re.kr">선박해양플랜트연구소</a></div>
  <div class="company3_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.fipa.or.kr">한국어촌어항협회</a></div>
  <div class="company4_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
 <div class="company1_picture"><a href="http://www.kaan.or.kr">항로표지기술협회</a></div>
  <div class="company1_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
  </div>
  <div class="company2_picture"><a href="http://www.kimst.re.kr">한국해양과학기술진흥원</a></div>
  <div class="company2_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company3_picture"><a href="http://www.fira.or.kr">한국수산자원관리공단</a></div>
  <div class="company3_profile">
    <ul>
      <li>준정부기관(위탁집행형)</li>
    </ul>
  </div>
  <div class="company4_picture"><a href="http://www.koem.or.kr">해양환경관리공단</a></div>
  <div class="company4_profile">
    <ul>
      <li>공기업(준시장형)</li>
    </ul>
  </div>
  <div class="company5_picture"><a href="http://https://www.khra.kr/">한국해양조사협회</a><a href="http://www.airport.co.kr"></a></div>
  <div class="company5_profile">
    <ul>
      <li>기타공공기관</li>
    </ul>
