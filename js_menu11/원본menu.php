...
$(function(){
	//$('#kwd').removeClass('keyword');
	$("#kwd").css('color', '#a3a3a3');
	$('#kwd').val('기사, 트윗검색');
	$('#kwd').on('focus', function(){
	...
	<ul class="mother">
	    ...
	    <!--<li><a href="/menuhtml/ns/ns2.php"><span><img src="/images/tongjin.gif" width="37" height="26" align="absmiddle"></span></a>-->
	  	    <ul class="child">
				...
				<li><a href="/menuhtml/logout/logout.php"><?=사이트맵?></a></li>
			 </ul>
		...
		<li>
            ...
            <span><input accesskey="s" class="keyword" id='kwd' title=검색어 name="stx" type="text" maxlength="20" value="<?=$stx;?>" > <input alt=검색 src="<?=$g4[layout_skin_path]?>/img/btn_srch.gif" type="image" alt=""></span>
            </form>
