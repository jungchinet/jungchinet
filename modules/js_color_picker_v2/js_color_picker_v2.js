...
************************************************************************************************************/	
  ...
  picker_path = g4_path + "/modules/js_color_picker_v2/";
	...
	var form_widget_amount_slider_handle = picker_path + 'images/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = picker_path + "images/tab_right_active.gif"
					...
					img.src = picker_path + "images/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = picker_path + "images/tab_right_" + suffix + ".gif";
    ...
    // 불당이 추가한 코드 (RGB 선택시 텍스트박스의 color 변경)
