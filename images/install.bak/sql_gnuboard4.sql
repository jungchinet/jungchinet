...
CREATE TABLE `$g4[board_table]` (
  ...
  `bo_comment_read_level` TINYINT( 4 ) NOT NULL default '0',
  ...
  `bo_ccl` tinyint(4) NOT NULL default '0',
  `bo_source` TINYINT( 4 ) NOT NULL default '0',
  `bo_notice_comment_allow` VARCHAR( 255 ) NOT NULL default '',
  `bo_comment_notice` TEXT NOT NULL,
  `bo_related` TINYINT( 4 ) NOT NULL,
  `min_wr_num` INT( 11 ) NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `$g4[config_table]` (
  ...
  `cf_use_sex` tinyint(4) NOT NULL DEFAULT '0',
  `cf_use_birthdate` tinyint(4) NOT NULL DEFAULT '0',
  `cf_register_level` tinyint(4) NOT NULL DEFAULT '0',
  `cf_register_point` int(11) NOT NULL DEFAULT '0',
  `cf_icon_level` tinyint(4) NOT NULL DEFAULT '0',
  `cf_use_recommend` tinyint(4) NOT NULL DEFAULT '0',
  `cf_req_recommend` tinyint(4) NOT NULL,
  ...
  `cf_singo_intercept_count` int(11) NOT NULL,
  `cf_singo_point` int(11) NOT NULL,
  `cf_singo_point_send` int(11) NOT NULL,
  `cf_singo_point_recv` int(11) NOT NULL,
  `cf_singo_today_count` int(11) NOT NULL,
  `cf_hp_certify` tinyint(4) NOT NULL,
  `cf_hp_certify_message` varchar(255) NOT NULL,
  `cf_hp_certify_return` varchar(20) NOT NULL,
  `cf_no_comment_point_days` int(11) NOT NULL,
  `cf_password_change_dates` int(11) NOT NULL,
  `cf_retry_time_interval` int(11) NOT NULL,
  `cf_retry_count` int(11) NOT NULL,
  `cf_sms4_member` tinyint(4) NOT NULL,
  `cf_sms4_level` tinyint(4) NOT NULL,
  `cf_double_login` tinyint(4) NOT NULL,
  `cf_meta_author` varchar(255) NOT NULL,
  `cf_meta_keywords` varchar(255) NOT NULL,
  `cf_meta_description` varchar(255) NOT NULL,
  `cf_memo_mb_member` tinyint(4) NOT NULL,
  `cf_db_version` int(11) NOT NULL,
  `cf_use_recycle` tinyint(4) NOT NULL,
  `cf_recycle_table` varchar(255) NOT NULL,
  `cf_recycle_days` int(11) NOT NULL,
  `cf_delay_level` tinyint(4) NOT NULL,
  `cf_delay_point` int(11) NOT NULL
);
